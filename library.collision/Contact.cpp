...
void Contact::calculateContactBasis()
{
    ...
    MakeArrayVector3(contactTangent, 2);
...
Vector3 * Contact::calculateFrictionlessImpulse(Matrix3 * _inverseInertiaTensor[2])
{
...
Vector3 * Contact::calculateFrictionImpulse(Matrix3 * _inverseInertiaTensor[2])
{
    ...
    *deltaVelocity *= this->contactToWorld;
    ...
    Vector3 * velKill = new Vector3(this->desiredDeltaVelocity, -this->contactVelocity->y, -this->contactVelocity->z);
...
//    MakeArrayMatrix3(inverseInertiaTensor, 2);
